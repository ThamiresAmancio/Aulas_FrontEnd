...
estados.push(listaCidades[cont].nome);
}
...
const estados2 = listaCidades.map(pegarNomeEstado)

console.log (estados2)

//MAP
//Executa uma função(callback) em cada um dos elementos do array e retorna
// um array novo do  mesmo tamanho modificado ou não
//ARGUMENTOS PARA O CALLBACK
//1º elemento
//2º índice
//3º array 

//Tarefa criar um array com todas as cidades de um determinado estado 
...
//Solução Declarativa
const estadoSelecionado = (estado) => estado.sila == estadoEscolhido
const cidades2 = listaCidades.filter(estadoSelecionado);

console.log(cidades2)

//FILTER
//Filtra os elementos de um array  por meio de uma função
// (callback) e retorna um novo array
//ARGUMENTOS PARA O CALLBACK
//1º elemento
//2º índice
//3º array 
